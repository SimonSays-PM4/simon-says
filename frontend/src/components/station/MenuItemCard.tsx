    ...
    return<>
        <a onClick={onPress}
            ...
            <div className="flex flex-wrap gap-4 sm:justify-between lg:flex-nowrap">
                <h1><b>{orderMenuItem.name}</b></h1><p>{orderMenuItem.state == State.Done?<FaRegCheckCircle color="green" />:pressed?<ImCheckboxChecked />:<PiClockDuotone color="orange" className="animate-pulse"/>}</p>
            </div>
